...
const uint8_t gameSequence[] = {
  ...
  //                                             15 = LHS Stairs 
    ...
    // GAME_STATE_PLAY_INIT,                   0,      0,          4,          0,          0,                  0,              0,          XPOSOVERALL_NO_CHANGE,   0,                              0,                          0,                      0,
    // GAME_STATE_PLAY_INIT,                   0,      0,          4,          0,          0,                  0,              0,          XPOSOVERALL_NO_CHANGE,   0,                              0,                          0,                      0,
    // GAME_STATE_EMPEROR_INIT,                0,      0,          0,          0,          0,                  0,              0,          XPOSOVERALL_NO_CHANGE,   0,                              0,                          0,                      0,
    ...
    // GAME_STATE_PLAY_INIT,                   0,      0,          4,          0,         60,                  0,              0,          XPOSOVERALL_NO_CHANGE,   0,                              0,                          0,                      0,
    ...
    GAME_STATE_PRINCESS_SITTING,           18,      0,          0,          0,          0,                  0,              0,          XPOSOVERALL_NO_CHANGE,   0,                              0,                          0,                      0,
    GAME_STATE_PLAY_INIT,                  30,     15,          0,          0,          0,                  2,              0,          XPOSOVERALL_NO_CHANGE,   0,                              0,                          0,                      0,
    GAME_STATE_ENEMY_APPROACH_INIT,         0,      0,          2,          0,         55,                  2,              0,          XPOSOVERALL_NO_CHANGE,   IMMEDIATE_ACTION_FREQUENT,      RETREAT_ACTION_INFREQUENT,  ACTION_KICK_PREF,       MOVE_FWD_FREQUENT,
    GAME_STATE_PLAY_INIT,                   0,      0,          2,          0,         55,                  2,              0,          XPOSOVERALL_NO_CHANGE,   IMMEDIATE_ACTION_FREQUENT,      RETREAT_ACTION_INFREQUENT,  ACTION_KICK_PREF,       MOVE_FWD_FREQUENT,
    GAME_STATE_ENEMY_APPROACH_INIT,         0,      0,          3,          0,         50,                  2,              0,          XPOSOVERALL_NO_CHANGE,   IMMEDIATE_ACTION_FREQUENT,      RETREAT_ACTION_NORMAL,      ACTION_NO_PREF,         MOVE_FWD_FREQUENT,
    GAME_STATE_PLAY_INIT,                   0,      0,          3,          0,         50,                  2,              0,          XPOSOVERALL_NO_CHANGE,   IMMEDIATE_ACTION_FREQUENT,      RETREAT_ACTION_NORMAL,      ACTION_NO_PREF,         MOVE_FWD_FREQUENT,
    GAME_STATE_GO_THROUGH_GATE,             0,      2,          0,          0,          0,                  2,              0,          XPOSOVERALL_NO_CHANGE,   0,                              0,                          0,                      0,
    GAME_STATE_FINAL_SCENE,                 0,      0,          0,          0,          0,                  0,              0,          XPOSOVERALL_NO_CHANGE,   0,                              0,                          0,                      0,
